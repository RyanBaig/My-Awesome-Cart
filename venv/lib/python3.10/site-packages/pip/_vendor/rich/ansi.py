...
def _ansi_tokenize(ansi_text: str) -> Iterable[_AnsiToken]:
    ...
    for match in re_ansi.finditer(ansi_text):
        ...
        if start > position:
<<<<<<< HEAD:.venv/Lib/site-packages/pip/_vendor/rich/ansi.py
...
=======
        ...
        yield _AnsiToken("", sgr, osc)
>>>>>>> 230c81d6c6e6bc8c84d019f65864439a6c2ac408:venv/lib/python3.10/site-packages/pip/_vendor/rich/ansi.py
        position = end
