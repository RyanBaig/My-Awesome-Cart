...
<<<<<<< HEAD:.venv/Lib/site-packages/pip/_vendor/tenacity/wait.py
    def __init__(self, wait: _utils.time_unit_type) -> None:
        self.wait_fixed = _utils.to_seconds(wait)
=======
    def __init__(self, wait: float) -> None:
        self.wait_fixed = wait
>>>>>>> 230c81d6c6e6bc8c84d019f65864439a6c2ac408:venv/lib/python3.10/site-packages/pip/_vendor/tenacity/wait.py
